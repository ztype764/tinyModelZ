 ...
 * 
 * <p>Unit tests for text generation and sampling logic (Greedy, Temperature, Top-K, Top-P).</p>
 */
public class GeneratorTest {
    ...
    private static void testTemperatureScaling() {
        // Run multiple times and verify that with high temperature we get multiple indexes,
        ...
        // High temperature (100.0) -> should be close to uniform, sampling index 0 and 2 sometimes
    ...
    private static void testTopKFiltering() {
        Generator generator = new Generator(42);
        // Let's set topK = 2. The top 2 largest logits are at index 1 (10.0) and 3 (5.0).
    ...
    private static void testTopPFiltering() {
        Generator generator = new Generator(42);
        // Let's set topP = 0.9.
        // Logits: index 1 is very large (10.0), next is index 3 (2.0), then index 0 (0.1)
        // Softmax of logits will be dominated by index 1 (approx 0.999), meaning index 1 alone exceeds topP = 0.9.
    ...
    private static void testAutoregressiveGeneration() {
        ...
        com.tinymodelz.nn.Module model = new com.tinymodelz.nn.Module() {
            ...
            public Tensor forward(Tensor... inputs) {
                ...
                // Force logits of special tokens to be extremely negative so they are never sampled
