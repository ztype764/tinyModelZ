 ...
 * <ul>
 *   <li><b>Pass Rate ($P_{rate}$):</b> The ratio of passed test cases to the total number of executed tests:
 *       $$P_{rate} = \frac{N_{passed}}{N_{total}} \times 100\%$$</li>
 *   <li><b>Total Execution Time ($T_{total}$):</b> Sum of execution durations for all test cases:
 *       $$T_{total} = \sum_{i=1}^{N_{total}} d_i$$</li>
 *   <li><b>SVG Donut Chart Arc Offset ($S_{offset}$):</b> For a circle of radius $r = 70$, 
 *       the circumference is $C = 2 \pi r \approx 440$. The offset to represent the fail rate arc is:
...
public class TestReporter {
    ...
    public static class Suite {
        ...
        public int getPassedCount() {
            ...
            for (TestCase tc : tests) {
                if ("PASSED".equals(tc.status)) count++;
            }
            return count;
        }
        ...
        public int getFailedCount() {
            int count = 0;
            for (TestCase tc : tests) {
                if ("FAILED".equals(tc.status)) count++;
            }
            return count;
        }
    }
    ...
    public static void generateReport(String outputPath) {
        ...
        int strokeOffset = totalTests > 0 ? (int) (circumference * (1.0f - ((float) passedTests / totalTests))) : circumference;
        ...
        html.append("<!DOCTYPE html>\n")
            ...
            .append("      </div>\n")
            .append("      <div>\n")
            .append("        <span class=\"badge ").append(failedTests > 0 ? "badge-failure" : "badge-success").append("\">\n")
            ...
            .append("          <div class=\"stat-value\" style=\"color: var(--success);\">").append(passedTests).append("</div>\n")
            .append("        </div>\n")
            .append("        <div class=\"stat-box\">\n")
            .append("          <div class=\"stat-label\">Failed</div>\n")
            .append("          <div class=\"stat-value\" style=\"color: ").append(failedTests > 0 ? "var(--failure)" : "var(--text-main)").append(";\">").append(failedTests).append("</div>\n")
            .append("        </div>\n")
            .append("        <div class=\"stat-box\" style=\"grid-column: span 2;\">\n")
            .append("          <div class=\"stat-label\">Total Duration</div>\n")
            .append("          <div class=\"stat-value\" style=\"color: var(--accent);\">").append(totalDuration).append(" ms</div>\n")
            .append("        </div>\n")
            .append("      </div>\n")
            .append("      \n")
        ...
        for (Suite s : suites) {
            html.append("    <div class=\"suite-section\">\n")
                ...
                .append("        <div class=\"suite-meta\">Passed: ").append(s.getPassedCount()).append("/").append(s.tests.size())
            ...
            for (TestCase tc : s.tests) {
                ...
                html.append("        <details>\n")
                    ...
                    .append("              <div class=\"status-indicator ").append(isPass ? "status-pass" : "status-fail").append("\"></div>\n")
